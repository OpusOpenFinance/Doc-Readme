...
| API                        | Link                                      |
| -------------------------- |:-----------------------------------------:|
| Renda fixa bancária        | [Neste link](/docs/rendafixabancaria)    |
| Renda fixa crédito         | [Neste link](/docs/rendafixacredito)     |
| Renda variável             | [Neste link](/docs/rendavariavel)        |
| Títulos do tesouro direto  | [Neste link](/docs/titulostesourodireto) |
| Fundos de investimento     | [Neste link](/docs/fundosinvestimento)   |
