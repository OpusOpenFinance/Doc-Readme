---
title: "Consentimento Compartilhado — Configuração e Implementação"
hidden: false
---

<!-- PREVIEW da separação (item #3) — revisar antes de aplicar -->
> _Página B — Guia técnico: configuração/setup das marcas, chaves, fluxo de aceite APP e WEB, checklists._
...
![Implementação em Kotlin](https://files.readme.io/735409c862af8c734d124da0e2126f8a3eb68115e00b6492e193da923358b3af-implementacaoKotlin.png)
...
![Imagem da Camada de Integração](https://files.readme.io/8ded3462e5c8fe43eeea3f77767375e3577935926505e778f876ca1cf7f323b2-camadaIntegracao.png)
...
- [Renda fixa bancária](/docs/rendafixabancaria);
- [Renda fixa crédito](/docs/rendafixacredito);
- [Renda variável](/docs/rendavariavel);
- [Títulos do tesouro direto](/docs/titulostesourodireto);
- [Fundos de investimento](/docs/fundosinvestimento).

Informações detalhadas sobre os dados necessários para este produto podem ser encontradas na [página específica para investimentos](/docs/investimentos).
...
[Dados-Cadastrais]: /docs/dadoscadastrais
[Cartão-crédito]: /docs/cartaodecredito
[Contas]: /docs/contas
[Crédito]: /docs/operacoesdecredito
[Câmbio]: /docs/cambio
[Empréstimo]: /docs/emprestimos
[Financiamento]: /docs/financiamento
[Adiantamento]: /docs/adiantamentodepositantes
[Direitos-Creditórios]: /docs/direitoscreditorios
