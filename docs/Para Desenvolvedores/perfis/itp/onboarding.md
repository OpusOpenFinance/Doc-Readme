...
![Etapas para se tornar ITP](https://files.readme.io/28782fbed89e9035ff7f330d0efd79f443991e9aec2491db16dc4225fe81164f-itp-etapas.png)
...
1. [**Certificação OpenID RP**](/docs/certificacoesecertificados):
...
3. **Certificação e publicação de APIs Payment** (se a instituição também for Detentora de Conta):
    Para o caso de a instituição ser participantes do Open Finance como Detentora de Conta também, é necessário estar de acordo com toda a regulação desse perfil antes mesmo de poder começar a homologação como ITP. O perfil de Detentora de Conta exige a publicação da [certificação OpenID OP](/docs/certificacoesecertificados) e que suas APIs estejam devidamente publicadas.
...
![Testes Pix](https://files.readme.io/2b867dbd9e5b372b9d1096cbfae259431e80508cfcd246dd18667500f34863fc-itp-etapasPix.png)
