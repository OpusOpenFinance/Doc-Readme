...
Para fazer o download do arquivo YAML/OAS que contém a especificação da API clique [**aqui**](/reference/invoice-financings).
...
[API-Direitos-Creditórios]: /reference/direitos-creditorios