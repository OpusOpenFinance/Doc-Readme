...
![Arquitetura geral](https://files.readme.io/ba9d63f5736c3766502206d47e9b8b58fcf66e38f478728c7fbd40525717d040-index-visaoGeral.png)
...
![Arquitetura voltada para escalabilidade](https://files.readme.io/ac820eb6e0bf541b4fa239922e0e09ae01cf7648a1e89e86713977c88721986c-index-escalabilidade.png)
...
![Roadmap](https://files.readme.io/ae0d5bb8fbcd61ac5b660985002d85c34a3d09b8f23cf3d5fa9056590e243977-index-roadmap.png)
...
- Preparação das evidências para envio à OpenID ([certificações RP e OP](/docs/certificacoesecertificados));
...
- Construção das telas da [jornada de consentimento](/docs/jornadaconsentimento):
...
- Integração dos sistemas de retaguarda da instituição ao produto, conforme o [perfil de participação da instituição financeira](/docs/perfisparticipacao). Tipicamente, [envolve a construção do *layer de integração*](/docs/integracaodaplataforma) adaptado aos sistemas de retaguarda da instituição.
...
- Aquisição dos [certificados digitais](/docs/certificacoesecertificados);
