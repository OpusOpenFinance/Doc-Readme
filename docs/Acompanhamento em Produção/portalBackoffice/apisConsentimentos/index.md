...
Para fazer o download do arquivo YAML/OAS que contém a especificação da API, clique [**aqui**](../openFinanceBrasil/perfisParticipacao/anexos/yml/oasOOFDados.yml).
